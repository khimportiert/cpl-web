// icon:seat-passenger | Material Design Icons https://materialdesignicons.com/ | Austin Andrews
import * as React from "react";

function IconSeatPassenger(props) {
  return (
    <svg
      viewBox="0 0 22 20"
      fill="currentColor"
...
export default IconSeatPassenger;
